...
class TEXT:
    ...
    UPLOAD_SUCESS = f"Thanks for using [me](https://github.com/AL3X-GITHUB)"
...
┣ ** Developer:** {bot_owner}
┣ ** Channel:** [BOT UPDATES](https://t.me/Ns_bot_updates)
┣ ** Group:** [BOT SUPPORT](https://t.me/Ns_Bot_supporters)
┗ ** Source Code:** [RenameBot](https://github.com/AL3X-GITHUB/RenameBot)
"""
...
**For Donate:** Message Me @MaximXRobot"""
